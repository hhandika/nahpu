...
part of 'site_queries.dart';

// ignore_for_file: type=lint
mixin _$SiteQueryMixin on DatabaseAccessor<Database> {
  ...
  SiteQueryManager get managers => SiteQueryManager(this);
}

class SiteQueryManager {
  final _$SiteQueryMixin _db;
  SiteQueryManager(this._db);
