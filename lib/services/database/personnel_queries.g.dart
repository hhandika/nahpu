...
part of 'personnel_queries.dart';
...
mixin _$PersonnelQueryMixin on DatabaseAccessor<Database> {
  ...
  PersonnelQueryManager get managers => PersonnelQueryManager(this);
}

class PersonnelQueryManager {
  final _$PersonnelQueryMixin _db;
  PersonnelQueryManager(this._db);
